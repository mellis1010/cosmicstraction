...
use crate::instructions::ExecuteMultisigStream;
use crate::state::STREAM_EXECUTION_FEE;
use crate::SAFE_SIGNER_PREFIX;

pub fn charge_fee(ctx: &Context<ExecuteMultisigStream>) -> Result<()> {
